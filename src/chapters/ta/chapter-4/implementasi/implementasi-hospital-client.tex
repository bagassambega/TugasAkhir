...
Keempat, setelah \textit{plaintext} berhasil diperoleh, \textit{client} memverifikasi \texttt{h\_plain} yang tersimpan di dalam \textit{payload} terenkripsi. 
Jika salah satu verifikasi tidak valid, \textit{client} menampilkan peringatan kepada tenaga kesehatan dan \textit{memanggil endpoint} invalidasi PGHD pada PRE yang dijelaskan pada Subbab~\ref{subsubsec:pre-endpoint-pghd-invalidate}, dengan alasan invalid.
