...
Diagram kelas utama pada \textit{client} tenaga kesehatan dapat dilihat pada Gambar~\ref{fig:diagram-modul-client-tenaga-kesehatan-pghd}.
Diagram tersebut menunjukkan relasi antara \textit{state} Svelte, \textit{command} Tauri, gateway IOTA, utilitas pemanggilan PRE, DTO, dan alur verifikasi serta dekripsi PGHD.
