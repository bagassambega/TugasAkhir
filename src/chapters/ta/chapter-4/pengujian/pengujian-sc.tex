...
Dengan demikian, pengujian tidak membutuhkan koneksi ke jaringan IOTA pada server kampus, IPFS, PRE, maupun Redis karena seluruh objek uji dibuat secara lokal pada lingkungan \textit{test} Move.
