...
Dengan demikian, pengujian tidak membutuhkan koneksi ke IOTA \textit{testnet}, IPFS, PRE, maupun Redis karena seluruh objek uji dibuat secara lokal pada lingkungan \textit{test} Move.
