...
\begin{styledxltabular}{|>{\raggedright\arraybackslash}p{0.09\textwidth}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}p{0.10\textwidth}|}
    ...
    \hline
    T-NF06 & Data yang belum selesai dikirim/diolah tetap ada, status kegagalan terlihat, dan setelah pemulihan setiap unit data selesai tepat satu kali. & Data yang belum terkirim tetap tersimpan dengan status kegagalan yang dapat ditelusuri. Setelah layanan pulih, seluruh unit data diselesaikan tepat satu kali tanpa duplikasi. & Sukses \\
    \hline
\end{styledxltabular}
