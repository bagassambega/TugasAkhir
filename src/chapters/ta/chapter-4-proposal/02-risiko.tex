...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textit{Rencana Mitigasi:} Membuat proof of concept untuk setiap integrasi secara bertahap, menggunakan API wrapper untuk standardisasi komunikasi, dan melakukan pengujian integrasi secara iteratif.
    \end{itemize}
    ...
    \item \textbf{Penerimaan dan Usability Portal Consent oleh Pasien}
    \begin{itemize}
        \item \textit{Deskripsi Risiko:} Portal consent yang terlalu kompleks dapat mengurangi adopsi pengguna, terutama untuk pasien dengan literasi digital rendah.
