...
\begin{table}[htbp]
    \centering
    \caption{Deskripsi \textit{field} tingkat batch pada skema JSON untuk PGHD}\label{tab:field-batch-json-pghd}
...
Sebelum batch PGHD dienkripsi, sistem membungkus \textit{plaintext} batch dengan hash \textit{plaintext}. 
...
\begin{table}[htbp]
    ...
    \begin{styledtable}{>{\raggedright\arraybackslash}p{0.25\textwidth} >{\raggedright\arraybackslash}p{0.18\textwidth} >{\raggedright\arraybackslash}X}
        ...
        \texttt{pghd\_data} & Objek & Payload batch PGHD sesuai Tabel~\ref{tab:field-batch-json-pghd}, Tabel~\ref{tab:field-datagroup-json-pghd}, dan Tabel~\ref{tab:field-datapoints-json-pghd}. \\
        ...
        \texttt{h\_plain} & String (Hex) & Hash SHA-256 dari \texttt{pghd\_data\_json}. Nilai ini diverifikasi kembali setelah \textit{ciphertext} berhasil didekripsi. \\
    \end{styledtable}
\end{table}
