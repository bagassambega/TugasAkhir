...
Analisis mengikuti tahapan \textit{threat modelling} pada Subbab~\ref{threat-model-studi}, yaitu mengidentifikasi aset dan ruang lingkup, menentukan aktor dan batas kepercayaan secara konseptual, dan mengidentifikasi ancaman menggunakan STRIDE\@. 
