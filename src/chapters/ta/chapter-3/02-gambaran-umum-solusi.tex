...
Sementara itu \textit{consent portal} dibuat untuk memberikan kemudahan dan keleluasaan bagi pasien untuk mengelola data dan akses secara granular dan informatif.
...
\begin{table}[htbp]
	...
	\begin{tabular}{|p{3.2cm}|p{2.2cm}|p{2.2cm}|p{2.2cm}|p{2.2cm}|} % chktex 44
		...
		\hline % chktex 44
		Fokus Utama & SSO, federasi & User ke aplikasi & User ke pihak lain \\
		\hline % chktex 44
...
Consent portal pasien akan dibentuk sebagai client terpisah dan berperan sebagai komponen pendefinisian policy (PAP, Policy Administration Point).
Consent portal akan memberikan definisi dan opsi bagi pasien untuk menentukan data yang akan dikontrol aksesnya, pihak yang diizinkan dan tipe akses apa yang diberikan.
