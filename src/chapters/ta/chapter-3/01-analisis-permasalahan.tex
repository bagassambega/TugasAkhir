...
PGHD sebaliknya dihasilkan secara mandiri oleh pasien di luar pengawasan langsung penyedia layanan kesehatan, sehingga tidak secara otomatis memiliki tingkat kepercayaan yang setara.
...
Ketidakmampuan sistem untuk mempertahankan akses baca selama durasi perawatan klinis membentuk \textbf{Gap 6}: \textit{tidak adanya mekanisme akses baca secara persisten berbasis status klinis pasien}.
