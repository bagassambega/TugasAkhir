...
Status PGHD yang tidak valid tidak menghapus riwayat transaksi lama, tetapi diperbarui melalui transaksi baru sehingga aplikasi selalu menggunakan state terkini.
...
Dari sisi server, mekanisme penjaminan ketersediaan pada arsitektur DecMed-PGHD didukung oleh tiga lapisan yang sudah melekat pada komponen-komponen yang dipilih. 
