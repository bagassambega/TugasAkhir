...
\textit{Digital signature} menggabungkan deteksi modifikasi dengan autentikasi identitas pengirim tanpa memerlukan pengiriman atau pembagian kunci enkripsi yang sama, karena \textit{digital signature} dienkripsi memakai kunci privat dan didekripsi memakai kunci publik yang aman untuk dibagikan \parencite{NIST_FIPS186-5}.
...
Seperti sudah dijelaskan pada pembahasan mengenai ketersediaan, subbab~\ref{studi-availability}, terdapat empat mekanisme penjaminan ketersediaan data PGHD yang dipertimbangkan, yaitu,
