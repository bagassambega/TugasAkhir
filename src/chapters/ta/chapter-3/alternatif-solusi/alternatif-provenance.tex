...
\begin{itemize}
    ...
    \item \textbf{Log dan \textit{ontology information} dalam bentul metadata kontekstual} seperti \textit{device type}, \textit{timestamp}, \textit{platform}, OS, dan sejenisnya. 
