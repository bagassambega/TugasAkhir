...
Teknik \textit{blockchain-based} memenuhi \textit{provenance security} melalui sifat \textit{immutability} dan memenuhi \textit{unforgeability} karena sangat sulit untuk melakukan modifikasi data secara tidak sah.
...
Berdasarkan analisis di atas, solusi \textit{data provenance} pada sistem ini adalah dengan mengkombinasikan empat kandidat berikut.
