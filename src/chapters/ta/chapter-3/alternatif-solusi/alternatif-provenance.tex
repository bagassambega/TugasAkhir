...
\begin{table}[htbp]
    ...
    \begin{styledtable}{%
        ...
        \textbf{Aspek provenance} & \textbf{Informasi yang dijamin} \\

        Dari mana data berasal
        & 
        Identitas pasien sebagai subjek data, identitas perangkat yang digunakan untuk mengumpulkan data, sumber platform atau layanan yang menyuplai data, serta rentang waktu pengukuran yang dicakup oleh suatu batch. \\

        Bagaimana data dihasilkan
        &
        Cara data dikumpulkan (otomatis oleh sensor, sesi aktif, atau input manual), jenis pengukuran yang dilakukan, pengelompokan data berdasarkan jenis pengukuran dan tipe perangkat, serta struktur batching yang digunakan saat pengiriman. \\

        Siapa yang memiliki/menghasilkan data
        &
        Pasien sebagai pemilik dan penghasil data, serta perangkat dan aplikasi yang bertindak sebagai agen teknis yang mengumpulkan dan mengirimkan data. \\

        Mengapa data dibuat / bagaimana data diolah
        &
        Alasan terbentuknya data, kapan pembentukan/pengiriman data dan status hasil verifikasi dan kegagalan jika terjadi. \\
