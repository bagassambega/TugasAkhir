...
\begin{enumerate}
    \item Bagaimana implementasi \textit{authorization framework} pasien dapat meningkatkan keamanan, privasi dan kontrol akses pasien dalam sistem rekam medis elektronik berbasis IOTA (DecMed)?\@
