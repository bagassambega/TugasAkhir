...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Desain Arsitektur Sistem}: Mendesain arsitektur sistem rekam medis elektronik terdesentralisasi yang mengintegrasikan \textit{authorization framework} dan \textit{portal consent}.
    ...
    \begin{enumerate}
        ...
        \item \textbf{Integrasi Komponen}: Melakukan integrasi antara komponen \textit{authorization framework} dan \textit{portal consent} dengan sistem DecMed.
