...
FHIR adalah standar dan regulasi pertukaran data rekam medis yang dibuat oleh HL7 dan sudah diadopsi oleh World Health Organization (WHO) \autocite{fhirspec}.
...
Dari berbagai teknologi desentralisasi yang disebutkan, IOTA merupakan teknologi desentralisasi yang paling efisien karena tidak membutuhkan biaya (gas fee) dan \textit{resources} yang tinggi dan juga terdesentralisasi penuh \autocite{zhengdltcomparisonmedicalrecord}.
...
Oleh karena itu selain solusi desentralisasi, diperlukan juga suatu mekanisme pemeriksaan otorisasi untuk memastikan akses terhadap data pasien bisa dikelola dengan baik \autocite{kheng2022delegatedauthhealthrecord}.
...
Beberapa solusi sistem diajukan untuk mengatasi permasalahan sistem SATUSEHAT yang tersentralisasi.
