...
Aktor yang terlibat dan juga hak izin aksesnya berdasarkan Permenkes Nomor 24 Tahun 2022 dan Undang-Undang Perlindungan Data Pribadi dapat dilihat pada Tabel~\ref{table:aktor-rme} \autocite{permenkes2022rekammedis,uudatapribadi,kepmenkesmetadatasatusehat}.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{6cm}|p{8cm}|} % chktex 44
        ...
        \hline % chktex 44
    \end{tabular}
    \label{table:aktor-rme} % chktex 24
\end{table}
...
\subsection{Consent Portal}

Consent portal adalah platform atau antarmuka digital yang memungkinkan pasien memberikan, mengelola, dan merekam persetujuan mereka terhadap penggunaan data kesehatan atau persetujuan tindakan medis secara elektronik \autocite{usinformedconsent}.

Pada umumnya consent portal terdiri atas fungsionalitas untuk:
\begin{itemize}
    \item Penyampaian informasi secara digital agar pasien memahami persetujuan yang diminta.
    \item Pengambilan persetujuan secara elektronik.
    \item Penyimpanan dan pencatatan audit trail.
    \item Integrasi dengan sistem rekam medis elektronik.
\end{itemize}

Akses granular (granular access control) adalah mekanisme kontrol akses yang sangat terperinci yang memungkinkan pemberian dan pembatasan hak akses hanya pada bagian tertentu dari data dan hanya untuk tindakan tertentu saja. 
Consent portal bagi pasien dapat meningkatkan granularitas kontrol akses yang didefinisikan oleh pasien \autocite{iconcur}.
...
% Untuk mengamankan pertukaran data melalui FHIR, SATUSEHAT mengadopsi standar OAuth 2.0 untuk autentikasi dan otorisasi. 
