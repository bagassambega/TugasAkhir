...
Selain itu, hanya pihak yang telah memperoleh persetujuan dari pasien yang boleh diberikan kemampuan teknis untuk mengakses PGHD \parencite{Khatiwada_Yang_Lin_Blobel_2024_PGHD_Understanding}.
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.6\textwidth]{resources/chapter-2/digital-signature.png}
...
\begingroup
\footnotesize
\begin{styledxltabular}{|>{\raggedright\arraybackslash}p{0.20\textwidth}|>{\raggedright\arraybackslash}X|>{\centering\arraybackslash}p{0.25\textwidth}|}
    \hiderowcolors
    ...
    \hiderowcolors
    \caption[]{Daftar Ancaman STRIDE dan Parameter Keamanannya (lanjutan)}\\
    \hline
    \rowcolor{headerBg}
    \textbf{Ancaman} & \textbf{Penjelasan} & \textbf{Parameter Keamanan} \\
    \hline
