...
\subsubsection{1. Pendaftaran dan Manajemen Identitas}
...
\subsubsection{2. Pendaftaran Sumber Daya (Resource Registration)}
...
\subsubsection{3. Mekanisme Pembuatan Kebijakan Akses (Consent Creation)}
...
\subsubsection{4. Mekanisme Rujukan}
...
\subsubsection{5. Logika Akses Tulis (Write Access Rules)}
