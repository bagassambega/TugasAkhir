...
gantt
    ...
    section Studi Literatur dan Analisis
    Analisis Sistem DecMed                          :a1, 2026-02-01, 4w
    Analisis Authorization Framework                :a2, 2026-02-15, 4w
    
    section Perancangan Sistem
    Perumusan Spesifikasi Kebutuhan                 :b1, 2026-03-01, 2w
    Desain Arsitektur Sistem                        :b2, 2026-03-15, 3w
    Pembuatan Model Alur Otorisasi dan Consent      :b3, 2026-04-01, 2w
    
    section Pengembangan Prototipe
    Implementasi Prototipe                          :c1, 2026-04-15, 5w
    Integrasi Komponen                              :c2, 2026-05-20, 2w
    Penyusunan Skenario Pengujian                   :c3, 2026-06-01, 2w
    
    section Pengujian dan Evaluasi
    Pengujian Fungsionalitas                        :d1, 2026-06-15, 2w
    Analisis Hasil Evaluasi                         :d2, 2026-06-29, 2w
```
...
- **Desain Arsitektur Sistem** (3 minggu): Mendesain arsitektur sistem yang mengintegrasikan authorization framework dan consent portal.
...
- **Integrasi Komponen** (2 minggu): Integrasi antara komponen authorization framework dan consent portal dengan DecMed.
